...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="master/css/metisMenu.min.css" rel="stylesheet">

    <!-- Timeline CSS -->
    <link href="master/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="master/css/startmin.css" rel="stylesheet">
...
<script src="master/js/metisMenu.min.js"></script>

<!-- Custom Theme JavaScript -->
<script src="master/js/startmin.js"></script>
